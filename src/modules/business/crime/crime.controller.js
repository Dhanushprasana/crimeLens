...
module.exports = {
  ...
  async addEvidence(req, res, next) { try { const { id } = req.params; const result = await service.addEvidence(id, req.body, req); sendResponse(res, result, 201); } catch (err) { next(err); } },
