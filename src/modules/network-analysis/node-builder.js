...
function criminal(criminalData) {
  return buildNode(
    "criminal",
    criminalData.ROWID,
    criminalData.full_name,
    criminalData.criminal_number,
    {
...
function suspect(suspectData) {
  return buildNode(
    "suspect",
    suspectData.ROWID,
    suspectData.full_name,
    suspectData.suspect_number,
    {
...
function alias(aliasData) {
  return buildNode(
    "alias",
    aliasData.ROWID,
    aliasData.alias_name,
    aliasData.alias_type || "Alias",
    {},
  );
}
...
function biometric(biometricData) {
  return buildNode(
    "biometric",
    biometricData.ROWID,
    biometricData.biometric_type || "Biometric",
    "Biometric Record",
    {
